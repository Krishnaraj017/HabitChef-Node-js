...
const topNutrientFoods = [
  {
    ...
    consForMen: ["High mercury content if consumed in excess"],
    prosForWomen: [
      "Supports bone health",
      "Helps reduce inflammation",
      "Supports skin health",
    ],
    consForWomen: ["Potential mercury exposure"],
  ...
  },
  {
    ...
    fiber: 2.2,
    description:
      "Nutrient-dense leafy green vegetable packed with vitamins and minerals",
    prosForMen: [
      "Supports muscle function",
      "Promotes prostate health",
      "Aids in testosterone regulation",
    ],
    consForMen: ["May interact with blood thinning medications"],
    prosForWomen: [
      "Supports bone density",
      "Helps manage menstrual health",
      "Promotes skin health",
    ],
    consForWomen: ["High oxalate content may affect kidney stone risk"],
  ...
  },
  {
    ...
    consForMen: ["High calorie content", "May cause allergic reactions"],
    prosForWomen: [
      "Supports hormonal balance",
      "Aids in weight management",
      "Promotes skin health",
    ],
    consForWomen: ["High calorie content", "May trigger nut allergies"],
    nutritientType: "Functional Food",
  },
  {
    name: "Eggs",
    ...
    consForMen: ["High cholesterol content", "Potential allergy concerns"],
    prosForWomen: [
      "Supports reproductive health",
      "Aids in weight management",
      "Promotes skin and hair health",
    ],
    consForWomen: ["May trigger hormonal acne in some individuals"],
  ...
  },
  {
    ...
    consForWomen: ["High sugar content for those monitoring blood sugar"],
    nutritientType: "Functional Food",
  },
  {
    name: "Quinoa",
    ...
    consForMen: ["May cause digestive issues in some individuals"],
    prosForWomen: [
      "Supports hormonal balance",
      "Aids in weight management",
      "Promotes bone health",
    ],
    consForWomen: ["Potential gluten sensitivity"],
    nutritientType: "Macronutrient",
  },
  {
    name: "Greek Yogurt",
    ...
    consForMen: ["Potential lactose intolerance", "High saturated fat content"],
    prosForWomen: [
      "Supports bone health",
      "Aids in weight management",
      "Promotes digestive health",
    ],
    consForWomen: ["May trigger hormonal imbalances in some individuals"],
    nutritientType: "Functional Food",
  },
  {
    name: "Kale",
    ...
    fiber: 3.6,
    description:
      "Nutrient-dense leafy green with powerful antioxidant properties",
    prosForMen: [
      "Supports cardiovascular health",
      "Aids in testosterone regulation",
  ...
  },
  {
    ...
    consForMen: ["High glycemic index for those monitoring blood sugar"],
    prosForWomen: [
      "Supports hormonal balance",
      "Aids in skin health",
      "Promotes fertility",
    ],
    consForWomen: ["May cause blood sugar spikes"],
    nutritientType: "Macronutrient",
  },
  {
    name: "Chicken Breast",
    ...
    consForWomen: ["May trigger hormonal imbalances if consumed in excess"],
    nutritientType: "Macronutrient",
  },
  {
    name: "Rice",
    ...
    antioxidants: ["Phytic Acid"],
    fiber: 0.4,
    description: "Staple grain with a high carbohydrate content",
    prosForMen: [
      "Supports muscle glycogen replenishment",
      "Promotes exercise recovery",
      "Aids in weight management",
    ...
    consForWomen: [
      "May trigger blood sugar spikes",
...
export async function seedNutrientsDatabase() {
  try {
    ...
    console.log(
      "Seeded Items:",
      allItems.map((item) => item.toJSON())
    );
  } catch (error) {
    console.error("Error seeding database:", error);
  } finally {
    // Only close the connection if this is standalone
